...
Gem::Specification.new do |s|
  ...
  s.date = "2016-06-03"
  s.description = "The easiest way to run tests of your iOS and Mac app"
  s.email = ["scan@krausefx.com"]
  s.executables = ["scan"]
  s.files = ["bin/scan"]
  ...
  s.summary = "The easiest way to run tests of your iOS and Mac app"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<fastlane>, [">= 1.25.0"])
      ...
      s.add_dependency(%q<fastlane>, [">= 1.25.0"])
